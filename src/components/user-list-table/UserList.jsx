...
export default function UserList({ userList, tableHead, associateToolbar, handleNew, actionOne, actionTwo }) {
  ...
  return (
    <MainCard>
      {associateToolbar ? <AssociateListToolbar filterName={filterName} onFilterName={handleFilterByName} /> : <UserListToolbar filterName={filterName} onFilterName={handleFilterByName} handleNew={handleNew} handleDelete={actionTwo} />}
      <TableContainer>
